...
const field =
  "w-full rounded-xl border border-line bg-white/[0.03] text-ink placeholder:text-faint transition-colors focus:border-cyan/50 focus:bg-white/[0.05] focus-visible:outline-none";
