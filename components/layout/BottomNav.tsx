      ...
      <div className="mx-auto max-w-md space-y-1.5">
        {nextMove && !onMap && (
          <Link
            ...
            className="flex items-center gap-2 rounded-2xl border border-accent/25 bg-canvas-2/85 px-4 py-2.5 backdrop-blur-xl"
          >
            <span className="h-1.5 w-1.5 shrink-0 rounded-full bg-accent" style={{ boxShadow: "0 0 8px #e6b877" }} />
            <span className="shrink-0 text-[10px] font-medium uppercase tracking-[0.14em] text-accent/80">Next</span>
