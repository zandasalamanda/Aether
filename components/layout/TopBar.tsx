...
export function TopBar({ user, className }: { user: SessionUser; className?: string }) {
  return (
    <header className={cn("sticky top-0 z-30 flex items-center justify-between border-b border-line bg-canvas/70 px-4 pt-[calc(0.75rem+env(safe-area-inset-top))] pb-3 backdrop-blur-xl", className)}>
